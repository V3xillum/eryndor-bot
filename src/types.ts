...
export interface Messages {
  ...
  weatherSettingsHubPrompt: string;
  weatherSettingsHubPlaceholder: string;
  weatherSettingsHubNotYours: string;
  weatherSettingsHubDialSeverity: string;
  weatherSettingsHubDialSeverityNone: string;
  weatherSettingsHubDialMagical: string;
  weatherSettingsHubDialMagicalNone: string;
  weatherSettingsHubOptInterval: string;
  weatherSettingsHubOptIntervalDesc: string;
  weatherSettingsHubOptWindow: string;
  weatherSettingsHubOptWindowDesc: string;
  weatherSettingsHubOptCooldown: string;
  weatherSettingsHubOptCooldownDesc: string;
  weatherSettingsHubOptSeverity: string;
  weatherSettingsHubOptSeverityDesc: string;
  weatherSettingsHubOptMagical: string;
  weatherSettingsHubOptMagicalDesc: string;
  weatherSettingsHubDialActionSet: string;
  weatherSettingsHubDialActionSetDesc: string;
  weatherSettingsHubDialActionClear: string;
  weatherSettingsHubDialActionClearDesc: string;
  weatherSettingsHubFieldDialAction: string;
  weatherSettingsHubFieldDialActionHint: string;
  weatherSettingsHubOptClear: string;
  weatherSettingsHubOptClearDesc: string;
  weatherSettingsHubClearPrompt: string;
  weatherSettingsHubClearPlaceholder: string;
  weatherSettingsHubClearSchedule: string;
  weatherSettingsHubClearCooldown: string;
  weatherSettingsHubClearAll: string;
  weatherSettingsHubModalIntervalTitle: string;
  weatherSettingsHubModalIntervalIntro: string;
  weatherSettingsHubModalWindowTitle: string;
  weatherSettingsHubModalWindowIntro: string;
  weatherSettingsHubModalCooldownTitle: string;
  weatherSettingsHubModalCooldownIntro: string;
  weatherSettingsHubModalSeverityTitle: string;
  weatherSettingsHubModalSeverityIntro: string;
  weatherSettingsHubModalMagicalTitle: string;
  weatherSettingsHubModalMagicalIntro: string;
  weatherSettingsHubFieldMinMinutes: string;
  weatherSettingsHubFieldMaxMinutes: string;
  weatherSettingsHubFieldEnabled: string;
  weatherSettingsHubEnabledOn: string;
  weatherSettingsHubEnabledOff: string;
  weatherSettingsHubFieldWindowStart: string;
  weatherSettingsHubFieldWindowEnd: string;
  weatherSettingsHubFieldWindowTimeHint: string;
  weatherSettingsHubFieldAfter: string;
  weatherSettingsHubFieldMaxNext: string;
  weatherSettingsHubFieldSeverityMin: string;
  weatherSettingsHubFieldSeverityMax: string;
  weatherSettingsHubFieldDuration: string;
  weatherSettingsHubFieldDurationHint: string;
  weatherSettingsHubFieldMagicalMode: string;
  weatherSettingsHubMagicalOnly: string;
  weatherSettingsHubMagicalNone: string;
  dmSetupHubTitle: string;
  dmSetupHubPrompt: string;
  dmSetupHubPlaceholder: string;
  dmSetupHubNotYours: string;
  dmSetupHubUnset: string;
  dmSetupHubLineWeather: string;
  dmSetupHubLineCalendar: string;
  dmSetupHubLineResource: string;
  dmSetupHubOptWeather: string;
  dmSetupHubOptWeatherDesc: string;
  dmSetupHubOptCalendar: string;
  dmSetupHubOptCalendarDesc: string;
  dmSetupHubOptResource: string;
  dmSetupHubOptResourceDesc: string;
  dmSetupHubActPlaceholder: string;
  dmSetupHubActSet: string;
  dmSetupHubActSetDesc: string;
  dmSetupHubActClear: string;
  dmSetupHubActClearDesc: string;
  dmSetupHubActPromptWeather: string;
  dmSetupHubActPromptCalendar: string;
  dmSetupHubActPromptResource: string;
  dmSetupHubChannelPlaceholder: string;
  dmSetupHubChannelPromptWeather: string;
  dmSetupHubChannelPromptCalendar: string;
  dmSetupHubChannelPromptResource: string;
  dmSetupHubWeatherClearSuccess: string;
  dmSetupHubWeatherClearNone: string;
  dmSetupHubWeatherThreadNoParent: string;
  dmSetupHubCalendarNoThread: string;
  dmSetupHubResourceNoThread: string;
  ddbCharacterInvalidId: string;
  ddbCharacterNotFound: string;
  ddbCharacterPrivate: string;
  ddbCharacterInvalidPayload: string;
  ddbCharacterFetchError: string;
  ddbCharacterLevelLine: string;
  ddbCharacterClassLine: string;
  ddbCharacterClassWithSubclass: string;
  ddbCharacterClassJoin: string;
  ddbCharacterSkillsField: string;
  ddbCharacterSkillsFooter: string;
  ddbCharacterSkillLine: string;
  ddbCharacterFlagProficient: string;
  ddbCharacterFlagExpertise: string;
  ddbCharacterFlagNone: string;
  ...
  statusReportFieldUsageRetained: string;
  ...
  statusReportUsageRetainedBody: string;
  ...
  resourceWizardPersonalAddIntroTax: string;
  resourceWizardPersonalRemoveIntro: string;
  resourceWizardPersonalRemovePickPrompt: string;
  resourceWizardPersonalRemovePickPlaceholder: string;
  resourceWizardPersonalRemoveAmountHint: string;
  resourceWizardPersonalRemoveNoneEntered: string;
  resourceWizardPersonalRemovePartialFail: string;
  resourceWizardPersonalRemoveMultiSuccess: string;
  resourceWizardPersonalRemoveSuccessLine: string;
  resourceWizardOwnHouseLabel: string;
  resourceWizardOwnHouseDescription: string;
  ...
  dmResourceHubPrompt: string;
  dmResourceHubPlaceholder: string;
  dmResourceHubNotYours: string;
  dmResourceHubOptSetup: string;
  dmResourceHubOptSetupDesc: string;
  dmResourceHubOptClear: string;
  dmResourceHubOptClearDesc: string;
  dmResourceHubOptAdjust: string;
  dmResourceHubOptAdjustDesc: string;
  dmResourceHubOptCap: string;
  dmResourceHubOptCapDesc: string;
  dmResourceHubOptHouseTax: string;
  dmResourceHubOptHouseTaxDesc: string;
  dmResourceHubOptTypeAdd: string;
  dmResourceHubOptTypeAddDesc: string;
  dmResourceHubOptTypeEdit: string;
  dmResourceHubOptTypeEditDesc: string;
  dmResourceHubOptTypeRemove: string;
  dmResourceHubOptTypeRemoveDesc: string;
  dmResourceHubSetupPrompt: string;
  dmResourceHubSetupPlaceholder: string;
  dmResourceHubTypeEditPick: string;
  dmResourceHubTypeRemovePick: string;
  dmResourceHubCapTitle: string;
  dmResourceHubCapIntro: string;
  dmResourceHubCapAmountLabel: string;
  dmResourceHubCapAmountHint: string;
  dmResourceHubHouseTaxTitle: string;
  dmResourceHubHouseTaxIntro: string;
  dmResourceHubHouseTaxEnabledLabel: string;
  dmResourceHubHouseTaxThresholdLabel: string;
  dmResourceHubHouseTaxThresholdHint: string;
  dmResourceHubTypeAddTitle: string;
  dmResourceHubTypeAddIntro: string;
  dmResourceHubTypeNameLabel: string;
  dmResourceHubTypeSellLabel: string;
  dmResourceHubTypeBuyLabel: string;
  dmResourceHubTypeBuyHint: string;
  dmResourceHubTypeEditTitle: string;
  dmResourceHubTypeEditIntro: string;
  dmResourceHubTypeRenameLabel: string;
  ...
  resourceHouseTaxShow: string;
  resourceHouseTaxSuccess: string;
  resourceHouseTaxEnabledOn: string;
  resourceHouseTaxEnabledOff: string;
  resourceHouseTaxNothingSet: string;
  resourceInvalidHouseTaxThreshold: string;
  resourcePersonalAddSuccess: string;
  resourcePersonalAddTaxSuccess: string;
  resourcePersonalAddTaxSkippedFull: string;
  ...
  resourceEmbedBuildingDonateMultiDesc: string;
  resourceEmbedBuildingDonatePersonalMultiDesc: string;
  resourceEmbedBuildingDonateMultiLine: string;
  resourceEmbedBuildingDonatePersonalMultiLine: string;
  resourceEmbedBuildingFundDesc: string;
  resourceEmbedBuildingFundMultiDesc: string;
  resourceEmbedBuildingFundMultiLine: string;
  resourceEmbedContributeDesc: string;
  resourceEmbedPersonalAddDesc: string;
  resourceEmbedPersonalAddTaxDesc: string;
  resourceEmbedPersonalAddTaxSkippedDesc: string;
  resourceEmbedPersonalRemoveDesc: string;
  resourceEmbedPersonalRemoveMultiDesc: string;
  resourceEmbedPersonalRemoveMultiLine: string;
  ...
  dmProductionHubPrompt: string;
  dmProductionHubPlaceholder: string;
  dmProductionHubNotYours: string;
  dmProductionHubOptAdd: string;
  dmProductionHubOptAddDesc: string;
  dmProductionHubOptWorkers: string;
  dmProductionHubOptWorkersDesc: string;
  dmProductionHubOptYield: string;
  dmProductionHubOptYieldDesc: string;
  dmProductionHubOptRemove: string;
  dmProductionHubOptRemoveDesc: string;
  ...
  buildingCostAddMultiSuccess: string;
  buildingCostAddSuccessLine: string;
  ...
  buildingFundMultiSuccess: string;
  buildingFundSuccessLine: string;
  buildingDonateSuccess: string;
  buildingDonatePersonalSuccess: string;
  buildingDonateMultiSuccess: string;
  buildingDonatePersonalMultiSuccess: string;
  buildingDonateSuccessLine: string;
  ...
  buildingWizardFundingAdjustPickBuilding: string;
  buildingWizardFundingAdjustPickTypes: string;
  buildingWizardFundingAdjustPickTypesPlaceholder: string;
  buildingWizardFundingAdjustAmountIntro: string;
  buildingWizardFundingAdjustAmountHint: string;
  buildingWizardFundingAdjustMultiSuccess: string;
  buildingWizardFundingAdjustSuccessLine: string;
  buildingWizardFundingAdjustClampedNote: string;
  ...
  buildingWizardSpentAdjustAmountHint: string;
  dmBuildingHubPrompt: string;
  dmBuildingHubPlaceholder: string;
  dmBuildingHubNotYours: string;
  dmBuildingHubOptCreate: string;
  dmBuildingHubOptCreateDesc: string;
  dmBuildingHubOptCancel: string;
  dmBuildingHubOptCancelDesc: string;
  dmBuildingHubOptCostAdd: string;
  dmBuildingHubOptCostAddDesc: string;
  dmBuildingHubOptBuildtime: string;
  dmBuildingHubOptBuildtimeDesc: string;
  dmBuildingHubOptFunding: string;
  dmBuildingHubOptFundingDesc: string;
  dmBuildingHubOptSpent: string;
  dmBuildingHubOptSpentDesc: string;
  dmBuildingHubNoCancelable: string;
  dmBuildingHubCancelPick: string;
  dmBuildingHubCreateTitle: string;
  dmBuildingHubCreateIntro: string;
  dmBuildingHubCreateNameLabel: string;
  ...
  buildingSpentAdjustClampedNote: string;
  ...
  buildingWizardCostPickTypes: string;
  buildingWizardCostPickTypesPlaceholder: string;
  buildingWizardCostAmountIntro: string;
  buildingWizardCostAmountHint: string;
  buildingWizardFundPickBuilding: string;
  buildingWizardFundPickTypes: string;
  buildingWizardFundPickTypesPlaceholder: string;
  buildingWizardFundAmountIntro: string;
  buildingWizardFundAmountTitle: string;
  buildingWizardFundAmountHint: string;
  buildingWizardDeliverPickBuilding: string;
  buildingWizardDeliverPickSource: string;
  buildingWizardDeliverPickTypes: string;
  buildingWizardDeliverPickTypesPlaceholder: string;
  buildingWizardDeliverAmountTitle: string;
  buildingWizardDeliverAmountIntroOutside: string;
  buildingWizardDeliverAmountIntroPersonal: string;
  buildingWizardDeliverAmountHintOutside: string;
  buildingWizardDeliverAmountHintPersonal: string;
  buildingWizardMultiNoneEntered: string;
  buildingWizardMultiPartialFail: string;
...
export interface ResourceSettings {
  ...
  /** 0/1 — huisbelasting op persoonlijk toevoegen. */
  house_tax_enabled: number;
  /** Drempel: bij amount ≥ threshold + eigen huis → 1 unit naar guild. */
  house_tax_threshold: number;
}
