...
|---|---|---|---|
| `/world setup` | Kies in welk kanaal ochtend-kalenderposts komen (alleen op dagen mét events). Los van weerkanaal. | Inrichten | DM |
| `/world clear` | Zet die automatische ochtendposts uit. | Inrichten | DM |
...
- Kalender-tile: handmatig `/world today` / `fullmoon` **én** optioneel ochtendpost bij events.
- Max één setup-command: `` `/world setup` ``.
...
- `/world setup` + `/world clear` onder **Inrichten**.
